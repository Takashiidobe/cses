pub fn weird_algorithm(num: u64) -> Vec<u64> {
    let mut v = vec![];
    let mut n = num;
    loop {
        v.push(n);
...
test! {
    test_1: weird_algorithm(7), vec![7, 22, 11, 34, 17, 52, 26, 13, 40, 20, 10, 5, 16, 8, 4, 2, 1],
    test_2: weird_algorithm(15), vec![15, 46, 23, 70, 35, 106, 53, 160, 80, 40, 20, 10, 5, 16, 8, 4, 2, 1],
    test_3: weird_algorithm(27),
            vec![
